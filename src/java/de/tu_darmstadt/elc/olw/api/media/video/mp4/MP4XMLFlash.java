...
public class MP4XMLFlash implements XMLFlash {
	...
	public MP4XMLFlash(String lectureURL, String streamURL, String length) {
		super();
		this.lectureURL = lectureURL;
		this.streamURL = streamURL;
		this.length = length;
	...
	private void addMediaInfo(Element mediaNode) {
		mediaNode.addContent(new Element("type").setText(VIDEO_TYPE));
